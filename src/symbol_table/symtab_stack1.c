...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/07/01 16:05:14 by ygolshan          #+#    #+#             */
/*   Updated: 2023/07/01 16:05:14 by ygolshan         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
struct s_symtab	*symtab_stack_pop(void)
{
	...
	if (s_symtab_stack.symtab_count == 0)
		return (NULL);
	st = s_symtab_stack.symtab_list[s_symtab_stack.symtab_count
		- 1];
	...
	if (s_symtab_stack.symtab_count == 0)
	{
		...
		s_symtab_stack.local_symtab
			= s_symtab_stack.symtab_list[s_symtab_stack.symtab_count
			- 1];
	return (st);
}
