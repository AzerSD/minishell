...
/**
 * @param flags		Different properties assigned to 
 * variables and functions like export and readonly flags
...
/** @param symtab_count The number of the global
 *symbol table currently in the stack.*/
 ...
 * default prompt strings of our shell.
 * @see man environ
 * @see printenv
 */
