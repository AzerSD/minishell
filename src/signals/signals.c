...
/*   Updated: 2023/07/27 16:30:12 by lhasmi           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// This is a function used to change the action taken by
...
// This is a structure that specifies the new action to be taken for
// the signal. It is defined as:

//
// struct sigaction {
//     void     (*sa_handler)(int);// a pointer to the
// signal-handling function,
//     void     (*sa_sigaction)(int, siginfo_t *, void *);
//     sigset_t   sa_mask;
// the set of signals that should be blocked during execution
// of the signal handling function,
//     int        sa_flags; //options for signal handling
//     void     (*sa_restorer)(void);// obsolete and should not
// be used in new code.
// };
